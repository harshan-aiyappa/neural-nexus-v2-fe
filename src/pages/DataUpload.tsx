...
import { LuUpload, LuFileCode, LuNetwork, LuSparkles, LuFileJson, LuFileStack, LuZap, LuCheckCircle2, LuAlertCircle } from 'react-icons/lu';
            ...
            <VStack align="stretch" spaceY={10} w="full" maxW="1400px" mx="auto">
                ...
                <HStack w="full" align="stretch" spaceX={8}>
                    ...
                    <VStack flex={1} spaceY={8}>
                        ...
                        <Box w="full" p={6} bg="bg.surface" rounded="3xl" border="1px solid" borderColor="border.subtle" shadow="premium" className="upload-card">
                            <HStack spaceX={3} mb={4}>
                                <Circle size="8" bg="turf-green/10"><LuSparkles size="16px" color="var(--chakra-colors-turf-green)" /></Circle>
                                <Text fontSize="xs" fontWeight="black" color="fg" letterSpacing="widest">PROCESSING PIPELINE</Text>
                            </HStack>
                            <VStack align="stretch" spaceY={3}>
                                <StepItem icon={LuCheckCircle2} label="Document Segmentation & OCR" active />
                                <StepItem icon={LuCheckCircle2} label="Gemini Entity Resolution" active />
                                <StepItem icon={LuCheckCircle2} label="Knowledge Graph Mapping" />
                                <StepItem icon={LuCheckCircle2} label="Vector Alignment (768D)" />
                            </VStack>
                        </Box>
                    </VStack>
                </HStack>
                ...
                {status.message && (
                    ...
                    >
                        <HStack spaceX={4}>
                           <Icon 
                                as={status.type === 'error' ? LuAlertCircle : LuCheckCircle2} 
...
const StepItem = ({ icon, label, active = false }: any) => (
    <HStack gap={3} opacity={active ? 1 : 0.4}>
        <Icon as={icon} color={active ? "turf-green" : "fg.muted"} size="14px" />
